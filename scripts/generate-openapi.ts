...
registry.register('RequestedOutputDetails', schemas.requestedOutputDetailsSchema);
...
async function main() {
  try {
    ...
    console.log('Generated schemas:', Object.keys(openApiDocument.components?.schemas || {}));
  } catch (error) {
