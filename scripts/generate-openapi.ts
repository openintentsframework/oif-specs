...
// Define missing schemas locally where ts-to-zod cannot generate them
...
const orderSchema = z.union([
  schemas.oifEscrowOrderSchema,
  schemas.oifResourceLockOrderSchema,
  schemas.oif3009OrderSchema,
...
const postOrderRequestSchema = z.object({
  ...
  quoteId: z
    .string()
    .optional()
    .describe("Optional quote identifier from a prior Get Quote response"),
  originSubmission: schemas.originSubmissionSchema
    .optional()
    .describe(
